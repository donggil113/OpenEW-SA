...
\noindent\textbf{Conflict of Interest:} \textbf{[CONFLICT-OF-INTEREST STATEMENT PLACEHOLDER].}

\noindent\textbf{Data Availability:} \textbf{[DATA-AVAILABILITY AND DATA-LICENSE STATEMENT PLACEHOLDER].}

\noindent\textbf{Code Availability:} \textbf{[CODE-AVAILABILITY, REPOSITORY, VERSION, AND LICENSE STATEMENT PLACEHOLDER].}
