...
\begin{table}[t]
  ...
  \begin{tabularx}{\textwidth}{L{0.12\textwidth} L{0.17\textwidth} L{0.34\textwidth} L{0.11\textwidth} Y}
    ...
    \end{tabular}
    & 0.380724 to 1.000000 & Benign control drives the lowest macro-F1 through false abnormal predictions; abnormal-only jammer domains are easier. \\
    ...
    \end{tabular}
    & 0.385551 to 0.487570 & Reactive-family transfer remains difficult across jammer domains, with benign-control false abnormal predictions still limiting macro-F1. \\
    ...
    \begin{tabular}[t]{@{}l@{}}
      ...
      \artifact{bcn-L}
    \end{tabular}
    & 0.221060 to 0.618975 & Sensor-domain shift is strongest for Geneva, with DAB collapse and comparatively stronger FM/LTE transfer. \\
    \bottomrule
  \end{tabularx}
\end{table}
