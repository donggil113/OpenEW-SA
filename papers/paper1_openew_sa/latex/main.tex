...
\begin{table}[t]
  ...
  \begin{tabularx}{\textwidth}{L{0.13\textwidth} L{0.19\textwidth} L{0.10\textwidth} Y r r r r}
    ...
    DeepSense SDR WiFi & 4-channel WiFi occupancy classification & Tabular MLP & Train on day1 domains; report on held-out day2 domains. & 0.152 & 0.115 & -- & -- \\
    ...
    DeepSense SDR WiFi & 4-channel WiFi occupancy classification & IQ CNN 1D & Train on day1 domains; report on held-out day2 domains. & 0.281 & 0.218 & -- & -- \\
