...
This supplementary table preserves the domain-level values summarized in Table 3 of the main manuscript and visualized in Figure 3. No new experiments, generated CSV files, or raw data are introduced.
