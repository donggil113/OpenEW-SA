...
\newcommand{\figplaceholder}[2]{%
  \IfFileExists{../latex/#1}{%
    \includegraphics[width=0.92\linewidth]{../latex/#1}%
  }{%
    \IfFileExists{#1}{%
